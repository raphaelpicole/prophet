 ...
 */
export function parseICLHomepage(html: string): RawArticle[] {
 ...
 */
export function parseICLArticle(html: string): { title: string; content: string; published_at?: string } | null {
